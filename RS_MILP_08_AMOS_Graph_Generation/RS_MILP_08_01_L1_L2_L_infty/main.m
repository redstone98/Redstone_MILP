...
addpath ~/Desktop/Redstone_MILP/RS_MILP_08_AMOS_Graph_Generation/RS_MILP_08_01_L1_L2_L_infty/
...
%% 7. x_infty solver from L2
x_L_infinity = solve_L_infty(x_L2, number_of_missions ,number_of_SAT, A_si_info, b_si_info, E, P_matrix, f_vector, gvec ,E1_Si, S_i_info, U_i_info);
x_L_infinity(abs(x_L_infinity) < 1e-1) = 0;
row_index_L_infinity = x_L_infinity .* A_matrix(:,4);
row_index_L_infinity = row_index_L_infinity(row_index_L_infinity ~= 0);
[revisit_time_vector_L_infty, contact_tables_L_infty, revisit_vectors_L_infty, satellite_cadence_info_L_infty] = generate_revisit_table_L_infty(access_interval_table, row_index_L_infinity, A_matrix, tau);

function [revisit_time_vector_info, contact_tables, revisit_vectors, satellite_cadence_info] = generate_revisit_table_L_infty(access_interval_table, row_index_BCD, A_matrix, tau)
...
% Extract Ground Point Tables
  T = access_interval_table(row_index_BCD,:);
    ...
    hold off
    title("Revisit Time Result (L_\infty BCD from L_2, tau = " + tau + " sec)", 'FontSize',12,'FontWeight','bold');

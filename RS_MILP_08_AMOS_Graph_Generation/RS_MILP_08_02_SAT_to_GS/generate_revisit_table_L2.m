function [revisit_time_vector_info, contact_tables, revisit_vectors, satellite_cadence_info] = generate_revisit_table_L2(access_interval_table, row_index_BCD, A_matrix, tau)
...
% Extract Ground Point Tables
  T = access_interval_table(row_index_BCD,:);
    ...
    hold off
    title("Worldwide Ground Points Revisit Time Result (L_2 BCD, tau = " + tau + " sec)", 'FontSize',12,'FontWeight','bold');

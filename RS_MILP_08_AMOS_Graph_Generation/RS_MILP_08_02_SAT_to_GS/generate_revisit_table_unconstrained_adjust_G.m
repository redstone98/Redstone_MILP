function [revisit_time_vector_info, contact_tables, revisit_vectors, satellite_cadence_info] = generate_revisit_table_unconstrained_adjust_G(access_interval_table, A_matrix, t0, selected_gs)
...
% Extract Ground Point Tables
  T = access_interval_table;
    ...
    title('Lattice Result (Unconstrained)','FontSize',12,'FontWeight','bold');
